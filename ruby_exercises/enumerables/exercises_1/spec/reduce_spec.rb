RSpec.describe 'reduce' do
  ...
  it 'multiplies a list of numbers' do
    ...
    # initial value is 1
    # Your code goes here
    result = numbers.reduce(1) do |sum, num|
      sum * num
    end
  ...
  it 'capitalize key words in phrase' do
    ...
    # Your code goes here
    result = keywords.reduce('one fish two fish red fish blue fish') do |curr, word|
      curr.gsub!(word, word.upcase)
    end
  ...
  it 'divides 560 by a bunch of numbers' do
    ...
    # Your code goes here
    result = numbers.reduce(560) do |divide, num|
      divide / num
    end
  ...
  it 'subtract smallest values from 100' do
    ...
    # Your code goes here
    result = elements.reduce(100) do |arr, num|
      arr - num.min
    end
  ...
  it 'adds all second values together' do
    ...
    # initial value is 0
    # Your code goes here
    result = elements.reduce(0) do |arr, num|
      arr + num[1]
    end
